...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: {
      url: "https://assets.adarsh-67r.github.io/images/blog/arkanoid.webp",
      width: 1200,
      height: 630,
      alt: "Arkanoid",
    },
  ...
  twitter: {
    ...
    site: X_HANDLE,
    creator: X_HANDLE,
    images: ["https://assets.adarsh-67r.github.io/images/blog/arkanoid.webp"],
  },
}
...
export default function GamePage() {
  return (
    <div className="grid min-h-svh place-items-center py-6">
      <h1 className="sr-only">Arkanoid</h1>
